...
namespace Microsoft.AspNetCore.Mvc.FunctionalTests
{
    public class RoutingTests : IClassFixture<MvcTestFixture<RoutingWebSite.Startup>>
    {
        ...
        [Fact]
        public async Task HasEndpointMatch()
        {
            // Arrange & Act
        ...
        [Fact]
        public async Task AttributeRoutedAction_LinkWithName_WithNameOverridenFromController()
        {
            // Arrange & Act
        ...
        // Endpoint routing exposes HTTP 405s for HTTP method mismatches.
        protected void AssertCorsRejectionStatusCode(HttpResponseMessage response)
        {
            Assert.Equal(HttpStatusCode.MethodNotAllowed, response.StatusCode);
        }
    }
